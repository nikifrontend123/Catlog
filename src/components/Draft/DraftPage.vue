<template>
    <div>
        <NavLink active="Draft"></NavLink>
        <SearchBar></SearchBar>
            <div class="list container  w-100 justify-content-center align-items-center mt-3 opacity-50" style="padding-bottom: 80px;">
                <div v-for="(list, index) in lists" :key="index" class="">
                    <div class="btnlist w-100">
                        <div class="border-none cursor-pointer d-flex justify-content-center w-100 "
                            @click="showCatelog(list)">
                            <img :src="`${publicPath}${list.img}`" alt="">
                        </div>
                    </div>
                </div>
                <!-- Modal -->
                    ...
                    <div class="offcanvas offcanvas-end show" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
                        ...
                        <div class="offcanvas-header">
                            ...
                            <div class="d-flex justify-content-end w-100">
                                ...
                                <button type="button" class="btn eabtn fs-5 text-secondary p-0  "><i
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="first d-flex justify-content-between w-100">
                                                    <TextInputs class="w-100 " name="Quantity" type="text"
                                                        design="floating" />
                                                ...
                                                <div class="sec d-flex justify-content-between w-100">
                                                    ...
                                                    <label class="btn btn-outline-success"
                                                        for="success-outlined3">XL</label>
                                                </div>
                                                <div class="mt-2">
...
export default {
    components: { NavLink, SearchBar, TextInputs },
    data() {
        return {
